...
public class Submit {
  ...
  private List<String> validParts() {
    ...
    parts.add("Laplace Unigram Dev");
    parts.add("Laplace Unigram Test");
    parts.add("Laplace Bigram Dev");
    parts.add("Laplace Bigram Test");
    parts.add("Stupid Backoff Dev");
    parts.add("Stupid Backoff Test");
    parts.add("Custom Dev");
    parts.add("Custom Test");
    return parts;
  }
  ...
  private List<List<String>> sources() {
    ...
    tmp.add("LaplaceUnigramLanguageModel.java");
    tmp.add("SpellCorrect.java");
    srcs.add(tmp);
    tmp = new ArrayList<String>(2);
    tmp.add("LaplaceUnigramLanguageModel.java");
    tmp.add("SpellCorrect.java");
    srcs.add(tmp);
    tmp = new ArrayList<String>(2);
    tmp.add("LaplaceBigramLanguageModel.java");
    tmp.add("SpellCorrect.java");
    srcs.add(tmp);
    tmp = new ArrayList<String>(2);
    tmp.add("LaplaceBigramLanguageModel.java");
    ...
    srcs.add(tmp);
    tmp = new ArrayList<String>(2);
    tmp.add("StupidBackoffLanguageModel.java");
    tmp.add("SpellCorrect.java");
    srcs.add(tmp);
    tmp = new ArrayList<String>(2);
    tmp.add("StupidBackoffLanguageModel.java");
    ...
    srcs.add(tmp);
    tmp = new ArrayList<String>(2);
    tmp.add("CustomLanguageModel.java");
    tmp.add("SpellCorrect.java");
    srcs.add(tmp);
    tmp = new ArrayList<String>(2);
    tmp.add("CustomLanguageModel.java");
  ...
  protected String output(int partId, String ch_aux) {
    ...
    LanguageModel lm; 
    switch(partId) {
      case 1: lm = new LaplaceUnigramLanguageModel(trainCorpus); break;
      case 2: lm = new LaplaceUnigramLanguageModel(trainCorpus); break;
      case 3: lm = new LaplaceBigramLanguageModel(trainCorpus); break;
      case 4: lm = new LaplaceBigramLanguageModel(trainCorpus); break;
      case 5: lm = new StupidBackoffLanguageModel(trainCorpus); break;
      case 6: lm = new StupidBackoffLanguageModel(trainCorpus); break;
      case 7: lm = new CustomLanguageModel(trainCorpus); break;
      case 8: lm = new CustomLanguageModel(trainCorpus); break;
      default: System.out.println("Unknown partId: " + partId); return null;
    }
    SpellCorrect speller = new SpellCorrect(lm, trainCorpus);
    String output = speller.correctCorpus(testCorpus, partId);
    return output;
  }
